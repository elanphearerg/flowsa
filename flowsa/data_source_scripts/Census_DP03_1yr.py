# Census_DP03_1yr.py (flowsa)
# !/usr/bin/env python3
# coding=utf-8
"""
Pulls American Community Survey 1-yr Data Profile (DP03): Selected Economic Characteristics
--year = 'year' e.g. 2015
"""
import json
import pandas as pd
...
def DP03_1yr_URL_helper(*, build_url, year, **_):
    """
...
def DP03_1yr_parse(*, df_list, year, **_):
    """
    ...
    df['SourceName'] = 'Census_DP03_1yr'
    df['Description'] = 'Economic data from 1yr DP03'
    # Add tmp DQ scores
