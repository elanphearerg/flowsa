# Census_DP02_5yr.py (flowsa)
# !/usr/bin/env python3
# coding=utf-8
"""
Pulls American Community Survey 5yr Data Profile (DP02): Selected Social Characteristics
--year = 'year' e.g. 2015
"""
import json
import pandas as pd
...
def DP02_5yr_URL_helper(*, build_url, year, **_):
    """
...
def DP02_5yr_parse(*, df_list, year, **_):
    """
    ...
    df['SourceName'] = 'Census_DP02_5yr'
    df['Description'] = 'Social data from 5yr DP02'
    # Add tmp DQ scores
